...
export default function AboutPage() {
    return (
        <div className={styles.aboutPageDisplay}>
            ...
            <p>Users can sign in and manage a list of tasks via the Todos page.</p>
            <p>Tasks can be added and marked/unmarked as complete.</p>
            <p>By clicking a task, users can update the tasks' description or remove the task from the list.</p>
            <p>The list can be filtered using the search bar and/or sorted alphabetically, by creation date, or by completion status.</p>
